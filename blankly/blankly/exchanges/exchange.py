...
from blankly.exchanges.interfaces.upstox.upstox_interface import UpstoxInterface
...
class Exchange(ABCExchange, abc.ABC):
    ...
    def construct_interface_and_cache(self, calls):
        ...
        elif self.__type == "upstox":
            self.interface = UpstoxInterface(self.__type, calls)
